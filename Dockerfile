...
#RUN git clone -b main https://github.com/kaal0408/LUCIFERX /root/userbot
#RUN mkdir /root/userbot/bin/
#WORKDIR /root/userbot/
#RUN chmod +x /usr/local/bin/*
RUN wget https://raw.githubusercontent.com/kaal0408/LUCIFERX/main/manjeet.py
RUN wget https://raw.githubusercontent.com/kaal0408/LUCIFERX/main/requirements.txt
